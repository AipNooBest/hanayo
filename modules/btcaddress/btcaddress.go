// Package btcaddress makes sure the Bitcoin address for the Debiki donations
...
// The wallet with the name "Debiki" will be used for getting the address.
package btcaddress
